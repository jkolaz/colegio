...
(function(){
            ...
            proto:{
                setData:function(a,c){
                    ...
                    if(c)this.setHtml(a);
                        ...
                        CKEDITOR.env.gecko&&(a=a.replace(/<body/,'<body  id="editor_loco" contenteditable="true" '),2E4>CKEDITOR.env.version&&(a=a.replace(/<body[^>]*>/,"$&<\!-- cke-content-start --\>")));
    ...
    (function(){
        ...
        CKEDITOR.config.plugins='dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,div,resize,toolbar,elementspath,list,indent,enterkey,entities,popup,filebrowser,find,fakeobjects,floatingspace,listblock,richcombo,font,format,htmlwriter,horizontalrule,wysiwygarea,smiley,justify,liststyle,magicline,maximize,pagebreak,preview,removeformat,selectall,showblocks,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc';
